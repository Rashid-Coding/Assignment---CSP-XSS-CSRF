<?php
  ...
  if (isset($_POST['reg_user'])) {
    ...
    // Sanitize the input to prevent script injection @ XSS Defense
    $stud_id = htmlspecialchars($stud_id, ENT_QUOTES, 'UTF-8');
    $email = htmlspecialchars($email, ENT_QUOTES, 'UTF-8');
    $password_1 = htmlspecialchars($password_1, ENT_QUOTES, 'UTF-8');
    $password_2 = htmlspecialchars($password_2, ENT_QUOTES, 'UTF-8');
